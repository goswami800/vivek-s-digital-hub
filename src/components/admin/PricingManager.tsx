...
const PricingManager = () => {
  ...
  if (loading) return <p className="text-muted-foreground font-body">Loading packages...</p>;
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground font-body">Manage pricing displayed on the Pricing page.</p>
        </div>
